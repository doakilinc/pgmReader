...
#    executable.
#
restoration: restoration.o readaline.o openOrDie.o 
	$(CC) $(LDFLAGS) -o restoration  restoration.o readaline.o openOrDie.o $(LDLIBS)

unit_test: unit_test_driver.o restoration.o readaline.o 
	$(CXX) $(LDFLAGS) -o unit_test unit_test_driver.o restoration.o readaline.o $(LDLIBS)
